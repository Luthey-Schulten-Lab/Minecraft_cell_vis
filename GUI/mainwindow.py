...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget.setGeometry(QRect(590, 20, 241, 81))
        self.gridLayout = QGridLayout(self.widget)
        self.gridLayout.setObjectName(u"gridLayout")
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.label = QLabel(self.widget)
        self.label.setObjectName(u"label")
        self.label.setPixmap(QPixmap(u"mcvis\\icons\\amulet.png"))
        ...
        self.label_2.setPixmap(QPixmap(u"mcvis/icons/mc.png"))
        ...
        self.label_3.setPixmap(QPixmap(u"mcvis/icons/ms-icon-70x70.png"))
